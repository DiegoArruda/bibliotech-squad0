    ...
    return(
        ...
        <Card className="card" border="success">
            {showScore ? (
                ...
                <>
                <Card.Header className="card-header text-center">Quem escreveu...? {currentQuestion + 1}/{questions.length}</Card.Header>
                <p className="text-center">
                <img src={loginImg} width="250" alt="Logo" />
                </p>
                <div className="question-section">
                    <div className="question-text">
                        <Card.Body className="card-body"> {questions[currentQuestion].question}</Card.Body>
                    </div>
                </div>
